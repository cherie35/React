...
import { ReactComponent as Mail} from "../assets/images/message.svg";
    ...
    <Row style={{marginTop:'auto', marginBottom:'auto'}}>
      <Col xs={12} md={6} className={"innerAboutLeft"}>
        ...
        <Col md={12} className={'aboutText'}>
          ...
          <Fade bottom>
            <p className='aboutSub'>
              I'm Chérie Cederboom, a 19 year old Computer science student at the Rotterdam University of Applied Sciences.<br/>
              For as long as I can remember, I have always had an interest in art and tech.<br/>
              About 2 years ago I got introduced to the world of programming.<br/>
              
              It comes as no surprise that I ended up combining these subjects by starting my journey toward becoming a front-end developer.
        ...
        <Col  md={12}  className="logoBar">
          <Fade delay={800}>
            ...
            <a title={"get in touch"}  href="mailto:cherie-@hotmail.nl" target="blank">
              <Mail className='logos'/>
            </a> 
          </Fade>
        </Col>
      </Col>
      <Col xs={12} md={5} className={"innerAboutRight pb-5"}>
        <Col className={'insider py-5 '}>
          <Fade cascade duration={1800} delay={300}>
            ...
            <Col md={12}>
              ...
              <p className={'crows'}> GIMP · Photoshop · Lunacy · Figma</p>
            </Col>
            <Col md={12}>
